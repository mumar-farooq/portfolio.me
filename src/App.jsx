...
const PROJECTS = [
  { tag: 'UI/UX Design', title: 'A fintech dashboard redesign focused on clarity.', bg: '#FBE7E6' },
  { tag: 'Brand Identity', title: 'Visual identity for a boutique coffee roaster.', bg: '#E4EFEA' },
  { tag: 'Web Design', title: 'Marketing site for an early-stage SaaS product.', bg: '#EAE7F7' },
];
...
const SERVICES = [
  { icon: Palette, title: 'UI Design', desc: 'Interfaces that feel obvious the first time you see them.' },
  { icon: LayoutIcon, title: 'Web Design', desc: 'Marketing sites and landing pages built to convert.' },
  { icon: Code2, title: 'Development', desc: 'Clean, maintainable front-end and full-stack builds.' },
];

const TIMELINE = [
  { year: '2026', role: 'Senior Developer', place: 'Planetaria' },
  { year: '2025', role: 'Frontend Developer', place: 'Studio Nine' },
  { year: '2024', role: 'Web Designer', place: 'Freelance' },
];

const BLOG = [
  { title: 'Designing for clarity, not decoration', date: 'Jun 2026' },
  { title: 'What I learned shipping 50 projects', date: 'Apr 2026' },
  { title: 'A simple system for design tokens', date: 'Feb 2026' },
];
...
const ProjectCard = ({ project }) => {
  ...
  return (
    <Reveal>
      ...
      >
        <div style={{
          position: 'relative', background: project.bg, borderRadius: 12, padding: 20,
          marginBottom: 16, aspectRatio: '4 / 3', display: 'flex', alignItems: 'center', justifyContent: 'center',
          overflow: 'hidden',
        }}>
          <div style={{
            width: '90%', background: '#fff', borderRadius: 8, padding: '10px 14px',
...
const About = () => (
  <section id="about" style={{ background: T.card, padding: '90px clamp(20px,5vw,64px)' }}>
    <div style={{ maxWidth: 1180, margin: '0 auto' }}>
      ...
      <div className="hh-hero-grid" style={{
        ...
        <Reveal delay={0.1}>
          <p style={{
            ...
            I'm {NAME}, a software designer based in New York City. I care about
            the small details that make a product feel considered — spacing,
            copy, motion, all of it. Outside of client work I'm usually
            tinkering on side projects or writing about design systems.
          </p>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px,1fr))', gap: 24 }}>
        {BLOG.map((b, i) => (
          <Reveal key={b.title} delay={i * 0.08}>
            <div style={{ border: `1px solid ${T.line}`, borderRadius: 14, overflow: 'hidden', height: '100%' }}>
